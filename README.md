...
![An architecture overview of the Rain-Aware Image Deraining Network (RAINet).](Figures/MID_overview.png)

![Architecture of Image Decomposition Block (IDB).](Figures/SAE-M_updatedv3.png)
