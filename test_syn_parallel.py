...
parser.add_argument("--model_dir", type=str, default="./checkpoints/Rain100L_single", help='path to model files')
parser.add_argument("--data_path", type=str, default=r"/home/magecliff/rainnet/dataset/Rain100L/rain", help='path to testing data')
parser.add_argument("--gt_path", type=str, default=r"/home/magecliff/rainnet/dataset/Rain100L/norain", help='path to testing data')
    ...
    for epoch in (range(80,20, -5)):
        ...
        for img_name in (os.listdir(opt.data_path)):
            if is_image(img_name):
                ...
                gt_img_path = os.path.join(opt.gt_path, img_name)
